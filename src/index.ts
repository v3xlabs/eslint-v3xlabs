...
const plugin: ESLint.Plugin & {
    configs: {
        recommended: ESLint.Plugin['configs'][string];
        all: ESLint.Plugin['configs'][string];
    };
} = {
    rules: {},
    configs: {
        recommended: flatRecommended as ESLint.Plugin['configs'][string],
        all: flatRecommended as ESLint.Plugin['configs'][string],
    },
};
